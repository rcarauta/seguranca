...
var RedirectService = (function () {
    ...
    RedirectService.prototype.redirectWithCodeUrl = function (code) {
        ...
        this.authenticationService.getUrlUser('/seguranca/url_security.json')
            ...
            _this.authenticationService.redirectUserTokenAccess(url, localStorage.getItem('client_id'), resultado.client_secret, code, resultado.grant_type, resultado.url_redirect)
                .subscribe(function (resultado) {
    ...
    RedirectService.prototype.authenticateClient = function () {
        ...
        if (!localStorage.getItem('token')) {
            ...
            this.authenticationService.getUrl('/seguranca/url_security.json')
                ...
                _this.authenticationService.getClientCode(urlName[3])
                    .subscribe(function (res) {
                    if (res.code) {
                        resultado.client_id = res.code;
                        var parts = resultado.url.split('client_id=');
